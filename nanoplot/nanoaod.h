...
// Tue Jul 24 11:25:52 2018 by ROOT version 6.10/09
// from TTree Events/Events
// found on file: /tmp/bmaier/2E37E450-AC42-E811-9A3A-1418774117C7.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nGenPart;
   Float_t         GenPart_eta[165];   //[nGenPart]
   Float_t         GenPart_mass[165];   //[nGenPart]
   Float_t         GenPart_phi[165];   //[nGenPart]
   Float_t         GenPart_pt[165];   //[nGenPart]
   Int_t           GenPart_genPartIdxMother[165];   //[nGenPart]
   Int_t           GenPart_pdgId[165];   //[nGenPart]
   Int_t           GenPart_status[165];   //[nGenPart]
   Int_t           GenPart_statusFlags[165];   //[nGenPart]
   ...
   UInt_t          nJet;
   Float_t         Jet_area[149];   //[nJet]
   Float_t         Jet_btagCMVA[149];   //[nJet]
   Float_t         Jet_btagCSVV2[149];   //[nJet]
   Float_t         Jet_btagDeepB[149];   //[nJet]
   Float_t         Jet_btagDeepC[149];   //[nJet]
   Float_t         Jet_btagDeepFlavB[149];   //[nJet]
   Float_t         Jet_chEmEF[149];   //[nJet]
   Float_t         Jet_chHEF[149];   //[nJet]
   Float_t         Jet_eta[149];   //[nJet]
   Float_t         Jet_mass[149];   //[nJet]
   Float_t         Jet_neEmEF[149];   //[nJet]
   Float_t         Jet_neHEF[149];   //[nJet]
   Float_t         Jet_phi[149];   //[nJet]
   Float_t         Jet_pt[149];   //[nJet]
   Float_t         Jet_qgl[149];   //[nJet]
   Float_t         Jet_rawFactor[149];   //[nJet]
   Float_t         Jet_bReg[149];   //[nJet]
   Int_t           Jet_electronIdx1[149];   //[nJet]
   Int_t           Jet_electronIdx2[149];   //[nJet]
   Int_t           Jet_jetId[149];   //[nJet]
   Int_t           Jet_muonIdx1[149];   //[nJet]
   Int_t           Jet_muonIdx2[149];   //[nJet]
   Int_t           Jet_nConstituents[149];   //[nJet]
   Int_t           Jet_nElectrons[149];   //[nJet]
   Int_t           Jet_nMuons[149];   //[nJet]
   Int_t           Jet_puId[149];   //[nJet]
   Float_t         LHE_HT;
   ...
   Float_t         TkMET_sumEt;
   UInt_t          nTrigObj;
   Float_t         TrigObj_pt[136];   //[nTrigObj]
   Float_t         TrigObj_eta[136];   //[nTrigObj]
   Float_t         TrigObj_phi[136];   //[nTrigObj]
   Float_t         TrigObj_l1pt[136];   //[nTrigObj]
   Float_t         TrigObj_l1pt_2[136];   //[nTrigObj]
   Float_t         TrigObj_l2pt[136];   //[nTrigObj]
   Int_t           TrigObj_id[136];   //[nTrigObj]
   Int_t           TrigObj_l1iso[136];   //[nTrigObj]
   Int_t           TrigObj_l1charge[136];   //[nTrigObj]
   Int_t           TrigObj_filterBits[136];   //[nTrigObj]
   Int_t           genTtbarId;
   UInt_t          nOtherPV;
   ...
   Int_t           Jet_genJetIdx[149];   //[nJet]
   Int_t           Jet_hadronFlavour[149];   //[nJet]
   Int_t           Jet_partonFlavour[149];   //[nJet]
   ...
   UChar_t         Jet_cleanmask[149];   //[nJet]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/tmp/bmaier/2E37E450-AC42-E811-9A3A-1418774117C7.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/tmp/bmaier/2E37E450-AC42-E811-9A3A-1418774117C7.root");
      }
