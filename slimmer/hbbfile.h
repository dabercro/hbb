...
class hbbfile {
 ...
 public:
  ...
  float cmva_jet1_csv;
  float cmva_jet1_deepcmvab;
  float cmva_jet1_deepcsvb;
  ...
  float cmva_jet2_csv;
  float cmva_jet2_deepcmvab;
  float cmva_jet2_deepcsvb;
  ...
  float csv_jet1_cmva;
  float csv_jet1_csv;
  float csv_jet1_deepcmvab;
  float csv_jet1_deepcsvb;
  ...
  float csv_jet2_cmva;
  float csv_jet2_csv;
  float csv_jet2_deepcmvab;
  float csv_jet2_deepcsvb;
...
void hbbfile::set_jet(const jet_enum base, const panda::Jet& jet) {
  ...
  set(jet_names[static_cast<int>(base)] + "_deepcsvb", static_cast<float>(jet.deepCSVb));
  set(jet_names[static_cast<int>(base)] + "_deepcmvab", static_cast<float>(jet.deepCMVAb));
}
