...
#then
#
#    crombie skim --cut '(recoil > 150 || pfmet > 150) && met_filter == 1 && (ak8fatjet1 || ca15fatjet1 || (cmva_daughter_min_pt > 25 && cmva_daughter_max_pt > 50 && cmva_hbb_pt > 70))' --tree 'events' --copy 'hSumW' --run 'runNumber' --lumi 'lumiNumber' --event 'eventNumber' --freq 100000 --numproc $CrombieNLocalProcs --indir $CrombieFullDir/links --outdir $SCRATCH
#
