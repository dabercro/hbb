...
template <>
  void process_event<hbbfile>(hbbfile& output, const panda::Event& event, jetselect::JetSelector& jetselector) {
...
int main(int argc, char** argv) {
  return parse_then_send(argc, argv, parsed_main<hbbfile>);
}
